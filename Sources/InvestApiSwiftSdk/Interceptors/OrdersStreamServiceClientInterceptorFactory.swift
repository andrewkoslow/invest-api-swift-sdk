...
internal struct OrdersStreamServiceClientInterceptorFactory:
    ...
    func makeOrderStateStreamInterceptors() -> [GRPC.ClientInterceptor<Tinkoff_Public_Invest_Api_Contract_V1_OrderStateStreamRequest, Tinkoff_Public_Invest_Api_Contract_V1_OrderStateStreamResponse>] {
        return []
    }
