...
public struct Tinkoff_Public_Invest_Api_Contract_V1_PostOrderRequest {
  ...
  public var confirmMarginTrade: Bool = false
...
public struct Tinkoff_Public_Invest_Api_Contract_V1_GetOrdersRequest {
  ...
  public var advancedFilters: Tinkoff_Public_Invest_Api_Contract_V1_GetOrdersRequest.GetOrdersRequestFilters {
    get {return _advancedFilters ?? Tinkoff_Public_Invest_Api_Contract_V1_GetOrdersRequest.GetOrdersRequestFilters()}
    set {_advancedFilters = newValue}
  }
  /// Returns true if `advancedFilters` has been explicitly set.
  public var hasAdvancedFilters: Bool {return self._advancedFilters != nil}
  /// Clears the value of `advancedFilters`. Subsequent reads from it will return its default value.
  public mutating func clearAdvancedFilters() {self._advancedFilters = nil}

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public struct GetOrdersRequestFilters {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    ///Статусы заявок.
    public var executionStatus: [Tinkoff_Public_Invest_Api_Contract_V1_OrderExecutionReportStatus] = []
  ...
  fileprivate var _advancedFilters: Tinkoff_Public_Invest_Api_Contract_V1_GetOrdersRequest.GetOrdersRequestFilters? = nil
}
...
extension Tinkoff_Public_Invest_Api_Contract_V1_GetOrdersRequest.GetOrdersRequestFilters: @unchecked Sendable {}
...
extension Tinkoff_Public_Invest_Api_Contract_V1_PostOrderRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    11: .standard(proto: "confirm_margin_trade"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 11: try { try decoder.decodeSingularBoolField(value: &self.confirmMarginTrade) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.confirmMarginTrade != false {
      try visitor.visitSingularBoolField(value: self.confirmMarginTrade, fieldNumber: 11)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Tinkoff_Public_Invest_Api_Contract_V1_PostOrderRequest, rhs: Tinkoff_Public_Invest_Api_Contract_V1_PostOrderRequest) -> Bool {
    ...
    if lhs.confirmMarginTrade != rhs.confirmMarginTrade {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Tinkoff_Public_Invest_Api_Contract_V1_PostOrderAsyncRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    10: .standard(proto: "confirm_margin_trade"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try { try decoder.decodeSingularBoolField(value: &self.confirmMarginTrade) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.confirmMarginTrade != false {
      try visitor.visitSingularBoolField(value: self.confirmMarginTrade, fieldNumber: 10)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Tinkoff_Public_Invest_Api_Contract_V1_GetOrdersRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "account_id"),
    2: .standard(proto: "advanced_filters"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.accountID) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._advancedFilters) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._advancedFilters {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Tinkoff_Public_Invest_Api_Contract_V1_GetOrdersRequest, rhs: Tinkoff_Public_Invest_Api_Contract_V1_GetOrdersRequest) -> Bool {
    if lhs.accountID != rhs.accountID {return false}
    if lhs._advancedFilters != rhs._advancedFilters {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Tinkoff_Public_Invest_Api_Contract_V1_GetOrdersRequest.GetOrdersRequestFilters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Tinkoff_Public_Invest_Api_Contract_V1_GetOrdersRequest.protoMessageName + ".GetOrdersRequestFilters"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "from"),
    2: .same(proto: "to"),
    3: .standard(proto: "execution_status"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeRepeatedEnumField(value: &self.executionStatus) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.executionStatus.isEmpty {
      try visitor.visitPackedEnumField(value: self.executionStatus, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Tinkoff_Public_Invest_Api_Contract_V1_GetOrdersRequest.GetOrdersRequestFilters, rhs: Tinkoff_Public_Invest_Api_Contract_V1_GetOrdersRequest.GetOrdersRequestFilters) -> Bool {
...
extension Tinkoff_Public_Invest_Api_Contract_V1_ReplaceOrderRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    14: .standard(proto: "confirm_margin_trade"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 14: try { try decoder.decodeSingularBoolField(value: &self.confirmMarginTrade) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.confirmMarginTrade != false {
      try visitor.visitSingularBoolField(value: self.confirmMarginTrade, fieldNumber: 14)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
